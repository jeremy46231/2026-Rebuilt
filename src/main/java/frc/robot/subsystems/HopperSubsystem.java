...
public class HopperSubsystem extends SubsystemBase {
  ...
  public HopperSubsystem() {
    ...
    MotorOutputConfigs moc = new MotorOutputConfigs().withInverted(InvertedValue.Clockwise_Positive);
  ...
  public void rampUp() {
    motor.setControl(new VelocityVoltage(Constants.Hopper.TARGET_PULLEY_SPEED_M_PER_SEC * Constants.Hopper.MOTOR_ROTS_TO_METERS_OF_PULLEY_TRAVERSAL));
  }
  ...
  public boolean atSpeed() {
    return motor.getVelocity().getValueAsDouble() - Constants.Hopper.TARGET_PULLEY_SPEED_M_PER_SEC / Constants.Hopper.MOTOR_ROTS_TO_METERS_OF_PULLEY_TRAVERSAL <= tolerance;
  }
